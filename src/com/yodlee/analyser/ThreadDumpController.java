...
public class ThreadDumpController {
	...
	public static void display(String path) throws Exception{
		...
		filePath=ob.next();*/
		PrintWriter out = new PrintWriter(new FileWriter(path+"\\"+"HTTP_THREADS.txt"));
	...
	public static void display_nothttp(String path) throws Exception{
		...
		System.out.println("enter the path to the output file");
		filePath=ob.next();*/
		PrintWriter out = new PrintWriter(new FileWriter(path+"\\"+"NON_HTTP_THREADS.txt"));
	...
	public static void listFilesForFolder(final File folder) throws IOException {
		...
		for(File fentry :folder.listFiles()){
			if(fentry.getName().equals("NON_HTTP_THREADS.txt")) fentry.delete();
			else if(fentry.getName().equals("HTTP_THREADS.txt")) fentry.delete();
		}
